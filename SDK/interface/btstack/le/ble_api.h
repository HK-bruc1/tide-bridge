 ...
 *              不然连续操作的时候地址可能配置错位了
 *
 *  \function   ble_cmd_ret_e ble_op_ext_adv_addr_set(address).
 *
 *  \param      [in] address   地址.
 *
 *  \return     see ble_cmd_ret_e.
 */
/*************************************************************************************************/
#define ble_op_ext_adv_addr_set(address)     \
        ble_user_cmd_prepare(BLE_CMD_EXT_ADV_ADRESS, 1, address)
 ...
 */
/*************************************************************************************************/
#define ble_op_latency_open(con_handle)     \
	ble_user_cmd_prepare(BLE_CMD_LATENCY_OPEN, 1, con_handle)
...
/* ***************************************************************************/
/**
 * \Brief :       设置ble发射功率，改变状态之后未设置则是默认最大功率
 *
 * \Param :        level
 */
/* ***************************************************************************/
