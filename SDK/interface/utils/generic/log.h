...
#ifdef DONS_LOG
#define DS_TRACE_R(x, ...)  log_i("\e[31m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_G(x, ...)  log_i("\e[32m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_Y(x, ...)  log_i("\e[33m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_B(x, ...)  log_i("\e[34m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_F_R(x, ...)  log_i("\e[31m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_F_G(x, ...)  log_i("\e[32m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define DS_TRACE_F_Y(x, ...)  log_i("\e[33m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
#else
#define DS_TRACE_R(x, ...)  
#define DS_TRACE_G(x, ...)  
#define DS_TRACE_Y(x, ...)  
#define DS_TRACE_B(x, ...)  
#define DS_TRACE_F_R(x, ...)  
#define DS_TRACE_F_G(x, ...)  
#define DS_TRACE_F_Y(x, ...)  
#endif
