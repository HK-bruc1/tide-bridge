...
#if 0
/**************************************************************************
 * function: rdx_battery_get_charge_time_info
 * description: 
 * param (*)
 * return (*)
 **************************************************************************/
Charge_time* rdx_battery_get_charge_time_info(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    memset(&ct, 0, sizeof(Charge_time));
    syscfg_read(VM_RDX_CHARGE_TIME_INFO, &ct, sizeof(Charge_time));
    g_printf("rdx_battery_get_charge_time_info --> start_time: %d, level_80_time: %d, level_100_time: %d, disconnect_time: %d \n", ct.start_time, ct.level_80_time, ct.level_100_time, ct.disconnect_time);

    return &charge_time_info;
}

/**************************************************************************
 * function: rdx_battery_set_bound_status
 * description: 
 * param (u8) d
 * return (*)
 **************************************************************************/
void rdx_battery_set_charge_time_info(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_printf("rdx_battery_set_charge_time_info --> start_time: %d, level_80_time: %d, level_100_time: %d, disconnect_time: %d \n", charge_time_info.start_time, charge_time_info.level_80_time, charge_time_info.level_100_time, charge_time_info.disconnect_time);

    //set value.
    memset(&ct, 0, sizeof(Charge_time));
    ct.start_time = charge_time_info.start_time;
    ct.level_80_time = charge_time_info.level_80_time;
    ct.level_100_time = charge_time_info.level_100_time;
    ct.disconnect_time = charge_time_info.disconnect_time;
    syscfg_write(VM_RDX_NOTTA_BOUND_STATUS, &ct, sizeof(Charge_time));
}
