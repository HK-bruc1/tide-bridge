...
#endif
#if !TCFG_DIP_SWITCH_POWER_ENABLE || !TCFG_USB_CDC_BACKGROUND_RUN || \
    !TCFG_USB_SLAVE_CDC_ENABLE || !TCFG_USB_SLAVE_ENABLE || !TCFG_SD0_ENABLE
#error "T2620 factory CDC requires DIP, SD0 and background USB slave CDC"
#endif
