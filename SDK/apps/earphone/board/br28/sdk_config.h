...
#define TCFG_LOWPOWER_OSC_TYPE                    OSC_TYPE_BT_OSC  // 低功耗时钟源
#define TCFG_LOWPOWER_VDDIOM_LEVEL                VDDIOM_VOL_30V   // 强VDDIO
...
#define TWFG_APP_POWERON_IGNORE_DEV               2000             // 设备忽略时间（单位：ms）
// ------------功能配置.json------------
...
#define TCFG_AUDIO_DAC_MODE                       DAC_MODE_L_DIFF  // 输出方式
...
#define TCFG_AUDIO_MIC_LDO_VSEL                   7                // MIC LDO 电压
#define TCFG_AUDIO_MIC_LDO_ISEL                   3                // MIC LDO 电流
...
#define TCFG_ADC2_POWER_IO                        56229            // IO供电选择
...
#define TCFG_AUDIO_GLOBAL_SAMPLE_RATE             0x0              // 全局采样率
