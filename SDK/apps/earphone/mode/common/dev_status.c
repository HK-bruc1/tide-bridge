...
_WEAK_ void music_task_dev_online_start(char *in_logo)
{
...
//---------------------------------------------------------------------------
            //for test SD0 is ready to write.
            // if(msg[0] == DRIVER_EVENT_FROM_SD0){
            //     static u8 sd_test_flag = 0;
            //     u8 buf[50];
            //     void *file = fopen("storage/sd0/C/sdtest.txt", "w+");
            //     g_printf("sd test file open %x\n", file);
            //     if(file){
            //         for(int i = 0; i < 40; i++){
            //             if(sd_test_flag == 0){
            //                 int r = fwrite("66666666\r", 8, 1, file);
            //                 if(r > 0){
            //                     g_printf("sd test write %d\n", r);
            //                 }
            //             }else{
            //                 memset(buf, 0, 50);
            //                 int r = fread(buf, 8, 1, file);
            //                 if(r > 0){
            //                     g_printf("read: %s\n", buf);
            //                 }
            //             }
            //             sd_test_flag = !sd_test_flag;
            //         }
            //         fclose(file);
            //     }
            // }
