...
#pragma bss_seg(".aud_spatial_effect_dut.data.bss")
#pragma data_seg(".aud_spatial_effect_dut.data")
#pragma const_seg(".aud_spatial_effect_dut.text.const")
#pragma code_seg(".aud_spatial_effect_dut.text")
#endif
    ...
    if ((tws_api_get_tws_state() & TWS_STA_SIBLING_CONNECTED)) {
        ...
        if (tws_api_get_role() == TWS_ROLE_MASTER) {
            ...
            /* if (bt_media_is_running())  */
            {
                ...
                app_online_db_send_more(DB_PKT_TYPE_SPATIAL_EFFECT, (u8 *)buf, sizeof(buf));
            }
        }
    } else
