 ...
 * */
static u32 audio_effect_dev4_run(struct effect_dev4_node_hdl *hdl, s16 *indata, s16 *outdata, u32 indata_len)
{
#if 0
    //test 2to4
...
#endif
    printf(" effecs_dev4 in_ch_num %d, out_ch_num %d\n", hdl->dev.in_ch_num, hdl->dev.out_ch_num);
...
static void effect_dev4_ioc_start(struct effect_dev4_node_hdl *hdl)
{
    ...
    hdl->dev.effect_run = (u32 (*)(void *, s16 *, s16 *, u32))audio_effect_dev4_run;
