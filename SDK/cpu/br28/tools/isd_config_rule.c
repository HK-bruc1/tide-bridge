...
#define CONFIG_ENTRY_ADDRESS                    0x6000100             //程序入口地址，一般不需要修改(跟张恺讨论过把RESERVED_OPT=0合并到一个配置项)
...
/* AMONG_FILE_ALIGN = 2; //配置res 4字节对齐 */
...
#ifdef TCFG_CHARGE_CUR_MIN
ICHARGE_CURRENT_MIN = TCFG_CHARGE_CUR_MIN;
#endif
#ifdef TCFG_CHARGE_CUR_MAX
ICHARGE_CURRENT_MAX = TCFG_CHARGE_CUR_MAX;
#endif
ICHARGE_SELECT = TCFG_CHARGE_MA;
IFULL_SELECT = TCFG_CHARGE_FULL_MA;
#endif
...
#define CONFIG_VM_ADDR		0x1fc000 //0
#endif
...
#undef  CONFIG_EXIF_LEN
#define CONFIG_EXIF_LEN        0x2000       // 0x2000 = CONFIG_EXIF_LEN + CONFIG_DEBUG_LEN,将原本的CONFIG_EXIF_LEN追加多4K
#endif
...
#elif (defined TCFG_CONFIG_DEBUG_RECORD_ENABLE && TCFG_CONFIG_DEBUG_RECORD_ENABLE)
...
/*********************用户配置区**********************/
#if TCFG_ANCIF_FILE_SPACE == 0			/*ANCIF区域-自定义大小*/
#define CONFIG_ANCIF1_LEN	0xF00		//ANC文件分配空间
#define CONFIG_ANCIF_ADDR   0xFE000		//FLASH size - 0x1000 - CONFIG_ANCIF1_LEN
#define CONFIG_ANCIF1_ADDR	0xFE100		//CONFIG_ANCIF_ADDR + 0x100
#endif
/*********************用户配置区**********************/

/*******************非用户配置区**********************/
//加载ANC增益配置文件使能
#define CONFIG_ANCIF_GAINS_FILE_ENABLE		(TCFG_ANCIF_FILE_LOAD_SEL & 1)
//加载ANC系数配置文件使能
#define CONFIG_ANCIF1_COEFF_FILE_ENABLE		(TCFG_ANCIF_FILE_LOAD_SEL & 2)
...
//4Mbit:0x7E000 8Mbit:0xFE000 16Mbit:0x1FE000
#if CONFIG_FLASH_SIZE == 0x80000	//4M
#if TCFG_ANCIF_FILE_SPACE == 0x1000
#define CONFIG_ANCIF1_LEN	0xF00
#define CONFIG_ANCIF_ADDR   0x7E000
#define CONFIG_ANCIF1_ADDR	0x7E100

#elif TCFG_ANCIF_FILE_SPACE == 0x2000
#define CONFIG_ANCIF1_LEN	0x1F00
#define CONFIG_ANCIF_ADDR   0x7D000
#define CONFIG_ANCIF1_ADDR	0x7D100
#endif

#elif CONFIG_FLASH_SIZE == 0x100000	//8M
#if TCFG_ANCIF_FILE_SPACE == 0x1000
#define CONFIG_ANCIF1_LEN	0xF00
...
#elif CONFIG_FLASH_SIZE == 0x200000	//16M
#if TCFG_ANCIF_FILE_SPACE == 0x1000
#define CONFIG_ANCIF1_LEN	0xF00
#define CONFIG_ANCIF_ADDR   0x1FE000
#define CONFIG_ANCIF1_ADDR	0x1FE100

#elif TCFG_ANCIF_FILE_SPACE == 0x2000
#define CONFIG_ANCIF1_LEN	0x1F00
#define CONFIG_ANCIF_ADDR   0x1FD000
#define CONFIG_ANCIF1_ADDR	0x1FD100
#endif
