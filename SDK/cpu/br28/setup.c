...
void setup_arch()
{
    ...
    printf("CPU0：%x -> %x -> %x -> %x ",q32DSP(0)->ETM_PC3,q32DSP(0)->ETM_PC2,q32DSP(0)->ETM_PC1,q32DSP(0)->ETM_PC0);
    printf("CPU1：%x -> %x -> %x -> %x ",q32DSP(1)->ETM_PC3,q32DSP(1)->ETM_PC2,q32DSP(1)->ETM_PC1,q32DSP(1)->ETM_PC0);
